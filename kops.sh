...
aws s3api create-bucket --bucket pranaiflmtwo.kops --region us-east-1
aws s3api put-bucket-versioning --bucket pranaiflmtwo.kops --region us-east-1 --versioning-configuration Status=Enabled
